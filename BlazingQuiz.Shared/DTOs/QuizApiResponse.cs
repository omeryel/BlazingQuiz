...
namespace BlazingQuiz.Shared.DTOs
{
    ...
    {
        public static QuizApiResponse<TData> Success(TData data) => new QuizApiResponse<TData>(data, true, null);
        public static QuizApiResponse<TData> Fail(string errorMessage) => new QuizApiResponse<TData>(default, false, errorMessage);
    }
