...
namespace BlazingQuiz.Api.Data.Migrations
{
    ...
    [Migration("20241215150811_AT_totalQuestion_Quizes")]
    partial class AT_totalQuestion_Quizes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BlazingQuiz.Api.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsApproved = true,
                            Name = "Admin",
                            PasswordHash = "AQAAAAIAAYagAAAAEFQJt5Nu8F7uVMWGqOCeTT+O+ls4/UDKZgn75DR9E19lkf/UK1VX7vsdS+LX0ws1iQ==",
                            Phone = "1234567890",
                            Role = "Admin"
                        });
                });
