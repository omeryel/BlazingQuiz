...
namespace BlazingQuiz.Api.Data.Migrations
{
    ...
    [Migration("20241105201221_Initial")]
            ...
            modelBuilder.Entity("BlazingQuiz.Api.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsApproved = true,
                            Name = "Admin",
                            PasswordHash = "AQAAAAIAAYagAAAAEHdqVvXj+cNxpD+NViVA26UKIfwQEzN6hsT4m8j01NUpHE6jP1YLe50ILOEac9n5fQ==",
                            Phone = "1234567890",
                            Role = "Admin"
                        });
                });
